  ...
  const updatePreferences = async (newPreferences: Partial<UserPreferences>) => {
    ...
    try {
      ...
      const updatedPreferences: UserPreferences = {
        aesthetics: newPreferences.aesthetics || preferences?.aesthetics || [],
        shoppingGoals: newPreferences.shoppingGoals || preferences?.shoppingGoals || [],
        onboardingCompleted: newPreferences.onboardingCompleted ?? preferences?.onboardingCompleted ?? false,
