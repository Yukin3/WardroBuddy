    ...
    await retryOperation(async () => {
      ...
      if (querySnapshot.empty) {
        ...
        await addDoc(outfitsRef, {
          imageUrl: 'https://plus.unsplash.com/premium_photo-1675186049409-f9f8f60ebb5e?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8b3V0Zml0fGVufDB8fDB8fHww',
